...
raw_vld_set = np.load('/home/pachaya/AntolikData/SourceCode/Data/region'+Region_num+'/raw_validation_set.npy')
vldinput_set = np.load('/home/pachaya/AntolikData/SourceCode/Data/region'+Region_num+'/validation_inputs.npy')
vld_set = np.load('/home/pachaya/AntolikData/SourceCode/Data/region'+Region_num+'/validation_set.npy')
